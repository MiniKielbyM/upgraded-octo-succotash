 ...
 */
export type WhitelistMap = {
    [badword: string]: WhitelistWordData[];
};
/**
 ...
 */
export declare const preprocessWordLists: (badwords: string[], whitelist: string[], { checkCircumventions, considerPrecedingApostrophes, considerFollowUpApostrophes, }?: WordFilterOptions) => ProcessedWordLists;
